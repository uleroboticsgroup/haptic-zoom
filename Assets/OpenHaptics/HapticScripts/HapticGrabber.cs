...
public class HapticGrabber : MonoBehaviour 
{
	...
	void FixedUpdate () 
	{
        ...
        Vector2 workspacePosition = new Vector2(hapticDevice.transform.position.x, hapticDevice.transform.position.z);
        Vector2 avatarPosition = new Vector2(this.transform.position.x, this.transform.position.z);

        //Debug.Log(Vector2.Distance(workspacePosition, avatarPosition));
        ...
        */
        ...
        bool newButtonStatus = Input.GetKey(KeyCode.Space);
        bool oldButtonStatus = buttonStatus;
        buttonStatus = newButtonStatus;
